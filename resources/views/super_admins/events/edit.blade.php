                                    ...
                                    <div class="tab-content mt-2 p-2" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade mb-2 {{$key == 0 ? 'show active':''}}" id="nav-{{$language->code}}" role="tabpanel" aria-labelledby="nav-{{$language->code}}-tab">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name[{{$language->code}}]" value="{{ $event->getTranslation('name', $language->code); }}" class="form-control @if ($errors->has('name.'.$language->code)) is-invalid @endif" id="InputName-{{$language->code}}" placeholder="Please Enter" aria-describedby="NameError-{{$language->code}}" aria-invalid="true">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description[{{$language->code}}]" id="discription_editor_{{$language->code}}" class="form-control @if ($errors->has('description.'.$language->code)) is-invalid @endif" rows="3" placeholder="Please Enter" aria-describedby="DescriptionError-{{$language->code}}" aria-invalid="true">{{ $event->getTranslation('description', $language->code); }}</textarea>
                                ...
                                <div class="row">
                                                    ...
                                                    @if (count($event_categories) > 0)
                                                        ...
                                                        @foreach ($event_categories as $event_category)
                                                            <option value="{{ $event_category->id }}"
                                                                {{ $event->event_category_id == $event_category->id ? 'selected' : '' }}>
                                                                {{ $event_category->name }}
                                                            </option>
                                                        @endforeach
                                                    @else
                                        ...
                                        <div class="col-md-12 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select multiple aria-describedby="TagsError" aria-invalid="true"
                                                    id="tags_drop_down"
                                                    class="form-control curr-sym @if ($errors->has('tags')) is-invalid @endif"
                                                    name="tags[]">
                                                    @if (count($tags) > 0)
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input required type="date" min="{{ now()->toDateString() }}"
                                                value="{{ $event->starts_at }}" name="starts_at"
                                                class="form-control @if ($errors->has('starts_at')) is-invalid @endif"
                                                id="InputName" placeholder="Enter Starts At"
                                                aria-describedby="StartsAtError" aria-invalid="true">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input required type="date" min="{{ now()->toDateString() }}"
                                                value="{{ $event->ends_at }}" name="ends_at"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address_line_1"
                                                value="{{ $event->address_line_1 }}"
                                                class="form-control @if ($errors->has('address_line_1')) is-invalid @endif"
                                                id="InputName" placeholder="Enter Address Line 1"
                                                aria-describedby="AddressLine2Error" aria-invalid="true">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address_line_2"
                                                value="{{ $event->address_line_2 }}"
                                                class="form-control @if ($errors->has('address_line_2')) is-invalid @endif"
                                                id="InputName" placeholder="Enter Address LIne 2"
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" name="is_featured" value="1" @if ($event->is_featured) checked @endif class="custom-control-input"
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var eventSponsors = {!! json_encode($event->sponsers) !!};
