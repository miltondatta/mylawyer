        ...
        <div class="row mb-4 pt-4 pt-lg-0">
            ...
            <div class="col-sm-6">
                ...
                <ol class="breadcrumb float-sm-left">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('super_admin.broadcasts.index') }}">Media </a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-secondary">
                    ...
                    <!-- form start -->
                    <form id="quickForm" method="POST" action="{{ route('super_admin.broadcasts.update', ['broadcast' => $broadcast->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                        ...
                        <div class="row">
                                    ...
                                    <div class="tab-content mt-2 p-2" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade mb-2 {{$key == 0 ? 'show active':''}}" id="nav-{{$language->code}}" role="tabpanel" aria-labelledby="nav-{{$language->code}}-tab">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name[{{$language->code}}]" value="{{ $broadcast->getTranslation('name', $language->code); }}" class="form-control @if ($errors->has('name.'.$language->code)) is-invalid @endif" id="InputName-{{$language->code}}" placeholder="Please Enter" aria-describedby="NameError-{{$language->code}}" aria-invalid="true">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description[{{$language->code}}]" id="discription_editor_{{$language->code}}" class="form-control @if ($errors->has('description.'.$language->code)) is-invalid @endif" rows="3" placeholder="Please Enter" aria-describedby="DescriptionError-{{$language->code}}" aria-invalid="true">{{ $broadcast->getTranslation('description', $language->code); }}</textarea>
                            ...
                            <div class="row">
                            @if (isset($broadcast_categories))
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        <label for="InputName">Select Media Category :</label>
                                        <select aria-describedby="PodcastCategoryError" aria-invalid="true" id="podcast_categories_drop_down" class="form-control curr-sym @if ($errors->has('broadcast_category_id')) is-invalid @endif" name="broadcast_category_id">
                                            @if (count($broadcast_categories) > 0)
                                            <option value="">Select Media Category</option>
                                            @foreach ($broadcast_categories as $broadcast_category)
                                            <option value="{{ $broadcast_category->id }}" {{ $broadcast->broadcast_category_id == $broadcast_category->id ? 'selected' : '' }}>
                                                {{ $broadcast_category->name }}
                                            </option>
                                            @endforeach
                                            @else
                                            <option value="">No Media Category Exists</option>
                                            @endif
                                        </select>
                                        <span id="PodcastCategoryError" class="error invalid-feedback">
                                            @if ($errors->has('broadcast_category_id'))
                                            {{ $errors->first('broadcast_category_id') }}
                                            @endif
                                        </span>
                                    </div>
                                </div>
                                ...
                                @if (isset($tags))
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            <label for="InputName">Select Media Tags :</label>
                                            <select multiple aria-describedby="TagsError" aria-invalid="true"
                                                id="podcast_categories_drop_down"
                                                class="form-control curr-sym @if ($errors->has('tag_ids')) is-invalid @endif"
                                                name="tag_ids[]">
                                                @if (count($tags) > 0)
                                                    <option value="">Select Media Tags</option>
                                                    @foreach ($tags as $tag)
                                                        <option value="{{ $tag->id }}">
                                                            {{ $tag->name }}</option>
                                                    @endforeach
                                                @else
                                                    <option value="">No Media Tag Exists</option>
                                                @endif
                                            </select>
                                 ...
                                 <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select id="file_type_drop_down" aria-describedby="FileTypeError" aria-invalid="true"
                                                ...
                                                name="file_type">
                                                    ...
                                                    <option @if ($broadcast->file_type == 'audio') selected @endif value="audio">Audio</option>
                                                    <option @if ($broadcast->file_type == 'video') selected @endif value="video">Video</option>
                                            </select>
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select aria-describedby="LinkTypeError" aria-invalid="true"
                                                ...
                                                name="link_type">
                                                    <option @if ($broadcast->link_type == 'internal') selected @endif value="internal">Internal</option>
                                                    <option @if ($broadcast->link_type == 'external') selected @endif value="external">External</option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if ($broadcast->link_type == 'internal')
                                                <div class="custom-file-preview">
                                                    ...
                                                    <audio controls>
                                                        <source src="{{url($broadcast->audio)}}" type="audio/mpeg">
                                                        Your browser does not support the audio element.
                                                    </audio>
                                                    @else
                                                    <video controls width="640" height="360">
                                                        <source src="{{url($broadcast->video)}}" type="video/mp4">
                                    ...
                                    <div id="external" class="col-md-12 col-lg-4">
                                      <div class="form-group">
                                            ...
                                            <input value="{{ $broadcast->file_url }}" type="text" name="file_url"
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        @if ($broadcast->image)
                                        <div class="custom-file-preview">
                                            <img src="{{ url($broadcast->image) }}" width="75px" height="75px" alt="{{ $broadcast->name }}">
                                        </div>
                                        @else
                                        <div class="custom-file-preview">
                                            -- No Image Selected
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" name="is_active" value="1" @if ($broadcast->is_active) checked @endif class="custom-control-input"
                                            id="customSwitch1" aria-describedby="IsActiveError" aria-invalid="true">
                                            <label class="custom-control-label" for="customSwitch1">Select Media To Be
                                                Active
                                                Or Not</label>
                                        </div>
